...
plt.bar(results.keys(), results.values(), color=["deepskyblue", "orangered", "gray"])
plt.title("Lc0 vs. Stockfish – Match Results")
plt.ylabel("Number of Games")
plt.grid(axis="y", linestyle="--", alpha=0.7)
plt.tight_layout()
plt.savefig("2.5s_lc0_vs_stockfish_match_results.png")
plt.show()